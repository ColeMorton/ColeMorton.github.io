...
},{"./config.js":1,"./ipfs.js":3}],3:[function(require,module,exports){
(function (Buffer){
module.exports = function Sync() {
  // const ipfs = window.IpfsApi();
  const ipfs = window.IpfsApi('/ip4/127.0.0.1/tcp/8080');
  const ipfsGateway = window.IpfsApi('/ip4/127.0.0.1/tcp/8080');
  ...
  function getDataHash() {
    return ipfsGateway.name.resolve(ipnsHash).then((res) => {
...
},{"buffer":5,"underscore":11,"underscore-db":10}],4:[function(require,module,exports){
...
},{"./":9,"fs":4}],11:[function(require,module,exports){
//     Underscore.js 1.8.3
